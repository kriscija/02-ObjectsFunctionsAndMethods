...
#              downwards( it is a little weird, though I know that increased y values have dots closer to the top_
#
...
#            It draws objects on the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
# When you need a way to easily exit the window without forcibly quitting the function, mainly because it is convenient
#
#
